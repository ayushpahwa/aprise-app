...
export const AUTH_CONTENT_SWITCH_MODE = (isLoginMode?: boolean) =>
  !!isLoginMode ? "Create a new user" : "Log in instead";
...
export const AUTH_ALERT_LOGIN_ERROR_MESSAGE = () =>
  "Invalid credentials, please check your credentials and try again.";
export const AUTH_ALERT_REGISTER_ERROR_MESSAGE = () =>
...
export const VALIDATION_INVALID_INPUT = () =>
...
export const MANAGE_GROUP_SCREEN_TITLE = (editMode: boolean) =>
